...
# 第一个是类别   第二个是类别对应的名称   输出结果的时候方便查看
label_map = {0: 'cat',
             1: 'dog',
             }
# 训练集图片的位置
train_image_path = '/home/zhangcz/local_code/work/HOG_SVM/dataset/train/image128/'
# 测试集图片的位置
test_image_path = '/home/zhangcz/local_code/work/HOG_SVM/dataset/test/image128/'

# 训练集标签的位置
train_label_path = os.path.join('/home/zhangcz/local_code/work/HOG_SVM/dataset/train/image128','train.txt')
# 测试集标签的位置
test_label_path = os.path.join('/home/zhangcz/local_code/work/HOG_SVM/dataset/test/image128','test.txt')
